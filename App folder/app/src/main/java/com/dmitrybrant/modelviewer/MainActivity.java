...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        riversRef = storageRef.getReference().child("images/");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.download:
            {
                StorageReference ref = riversRef.child(filename + "_output.stl");
//                        storageRef.getReferenceFromUrl("/images").child("6924_output.stl");
                try {
                    final File localFile = File.createTempFile("images", "stl");
...
//            beginLoadModel(uri);
            ...
            StorageReference riversRef = storageRef.getReference().child("images/");
            filename = uri.getLastPathSegment();
            StorageReference newRef = riversRef.child(filename);
            UploadTask uploadTask = newRef.putFile(uri);
